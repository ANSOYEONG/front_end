						...
						success: function (res) {
							...
							{	
								...
								if (data.solddiv == 'Y'){
									...
									html += '			</li>';
									html += '			<li>';
									html += '				<a href="#none" role="button" data-sns="facebook" data-snsdata="{' + "'title':'[BASKINROBBINS]','description':'[" + t.title + "] " + t.explain + "','url':'http://2016testbaskin.baskinrobbins.co.kr/menu/view.php?seq=" + t.seq + "'}" + '">';
									html += '					<img src="/assets/images/common/icon_facebook.png" alt="FACEBOOK">';
									html += '				</a>';
									html += '			</li>';
									html += '			<li>';
									html += '				<a href="#none"  role="button" data-sns="twitter" data-snsdata="{' + "'title':'[BASKINROBBINS]','description':'[" + t.title + "] " + t.explain + "','url':'http://2016testbaskin.baskinrobbins.co.kr/menu/view.php?seq=" + t.seq + "'}" + '">';
									html += '					<img src="/assets/images/common/icon_twitter.png" alt="TWITTER">';
									html += '				</a>';
									html += '			</li>';
									html += '			<li>';
									html += '				<a href="#none" role="button" data-sns="copyurl" data-snsdata="{' + "'title':'[BASKINROBBINS]','description':'[" + t.title + "] " + t.explain + "','url':'http://2016testbaskin.baskinrobbins.co.kr/menu/view.php?seq=" + t.seq + "'}" + '">';
									...
									html += '	</nav>';
									html += '<p class="buy">';
									html += '<a href="'+t.buy+'" target="_blank">CELECTORY 구매하기</a>';
									html += '</p>';
									html += '</div>';
								}
							}
							...
							//ice.find('[data-sns="facebook"], [data-sns="twitter"]').attr('data-snsdata', "{'title':'[BASKINROBBINS]','description':'[" + t.title + "] " + t.explain + "','url':'http://2016testbaskin.baskinrobbins.co.kr/menu/view.php?seq=" + t.seq + "'}");
			...
			$.each($('[data-pinstagram]'), function () {
				...
				var viewInsta = function (opts) {
					$.ajax({
						...
						dataType: 'jsonp',
						timeout: 3000,
						url: 'https://api.instagram.com/v1/users/1535227389/media/recent',
						data: {
							access_token: '1535227389.a3ed757.4ce3f2aec0a7445ebe5e93407042595e',
							count: opts.dataLen
						},
						success: function (res) {
							console.log(res);
							...
							if (opts.dataLen) {
								for (var i = 0; i < opts.dataLen ; i++) {
									if (i%opts.pageLen == 0)
									{
										...
										t = data[i];
										//console.log(data[i], opts.dataLen);
										html += '<li>';
										html += '	<figure>';
										html += '		<a href="'+ t.link + '" target="_blank">';
										html += '			<img src="' + t.images.low_resolution.url + '" alt="">';
